...
namespace Test_Assignment_3
{
    public class LinkedListTests
    {
        ...
        public void TestClear()
        {
            ...
            Assert.True(this.linkedList.IsEmpty()); // Test the linked list is empty.
            Assert.AreEqual(0, this.linkedList.Size()); // Test the size is 0
        }
        ...
        public void TestSize()
        {
            ...
            Assert.AreEqual(4, this.linkedList.Size()); // Test the size is 4
        }
        ...
        public void TestRetrieve()
        {
            ...
            string value = (string)this.linkedList.Retrieve(2);

            Assert.AreEqual("c", value); // Test the value at index 2 is c
        }
        ...
        public void TestIndexOf()
        {
            ...
            Assert.AreEqual(2, index); // Test the index of c is 2
        }
        ...
        public void TestContains()
        {
            ...
            Assert.True(contains); // Test the linked list contains c
        }
    }
}
