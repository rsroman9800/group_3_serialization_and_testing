...
namespace Test_Assignment_3
{
    public class LinkedListTests
    {
		...
		[Test]
		public void TestDeleteNodeFromStart()
		{
			this.linkedList.Append("a");
			this.linkedList.Append("b");
			this.linkedList.Append("c");
		...
		[Test]
		public void TestReplaceNodeWithInvalidIndex()
		{
			this.linkedList.Append("a");

			Assert.Throws<IndexOutOfRangeException>(() => this.linkedList.Replace("b", 2));
		}

		[Test]
		public void TestInsertNodeWithInvalidIndex()
		{
			this.linkedList.Append("a");

			Assert.Throws<IndexOutOfRangeException>(() => this.linkedList.Insert("b", -1));
			Assert.Throws<IndexOutOfRangeException>(() => this.linkedList.Insert("b", 2));
		}
